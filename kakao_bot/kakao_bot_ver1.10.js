...
const defaultName = [
    ...
    //// 2025.10.12 카카오톡 버전업으로 기본닉 추가됨
    , "인사하는 춘식이", "고구마 먹는 춘식이", "우는 춘식이", "긁적이는 춘식이", "행복한 춘식이", "팝콘 먹는 춘식이", "노래하는 춘식이", "축하하는 춘식이", "박스에 들어간 춘식이", "억울한 춘식이", "배부른 춘식이", "인사하는 춘식이", "하트 든 춘식이"
    , "얼굴 부비는 라이언", "티비 보는 라이언", "볼 찌르는 라이언", "우는 라이언", "하트를 든 라이언", "돈 뿌리는 라이언", "누워있는 라이언", "자랑하는 라이언", "축하하는 라이언", "환영하는 라이언"
    , "휴가 즐기는 어피치", "하트 든 어피치", "흐물한 어피치", "뽀뽀하는 어피치", "춤추는 어피치", "슬픈 어피치", "한가한 어피치", "파티하는 어피치", "잘난체하는 어피치", "감동받은 어피치", "커피 마시는 어피치", "엉엉 우는 어피치"
    , "사랑에 빠진 죠르디", "한숨 쉬는 죠르디", "상담하는 죠르디", "집 지키는 죠르디", "누워있는 죠르디", "축하하는 죠르디", "일하는 죠르디", "하품하는 죠르디"
    , "손 흔드는 스카피", "생각이 많은 스카피", "생각이 떠오른 스카피", "인사하는 스카피", "화난 스카피"
    , "부끄러운 앙몬드", "간절한 앙몬드", "평온한 앙몬드"
    , "예민한 팬더주니어", "여행 가는 팬더주니어", "손 흔드는 팬더주니어"
    , "나른한 니니즈", "응원하는 니니즈", "반가워하는 니니즈", "춤추는 니니즈", "울고있는 니니즈"
    , "반가워하는 프렌즈", "간식 먹는 프렌즈", "멍한 프렌즈", "반가워하는 프렌즈", "인사하는 프렌즈", "나른한 프렌즈", "쉬고있는 프렌즈", "웃고있는 프렌즈", "생각에 잠긴 프렌즈"
];
